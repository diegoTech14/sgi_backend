...
CREATE TABLE `T_Diagnostico` (
    `cn_id_diagnostico` INTEGER NOT NULL AUTO_INCREMENT,
    `cf_fecha_diagnostico` DATETIME(3) NOT NULL,
    `ct_diagnostico` VARCHAR(191) NOT NULL,
    `cn_tiempo_estimado` INTEGER NOT NULL,
    `ct_observacion` VARCHAR(191) NOT NULL,
    `cn_id_usuario` VARCHAR(11) NOT NULL,
    `ct_codigo_incidencia` VARCHAR(11) NOT NULL,

    UNIQUE INDEX `T_Diagnostico_cn_id_diagnostico_key`(`cn_id_diagnostico`),
